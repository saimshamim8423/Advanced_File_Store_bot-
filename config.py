...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1977715968"))
...
USER_REPLY_TEXT = "​🚫Pʟᴇᴀꜱᴇ ᴅᴏɴ'ᴛ ᴍᴇꜱꜱᴀɢᴇ ᴍᴇ ᴅɪʀᴇᴄᴛʟʏ ɪ ᴀᴍ ᴏɴʟʏ ᴡᴏʀᴋ ꜰᴏʀ​ - @Anime_City_official"

ADMINS.append(OWNER_ID)
ADMINS.append(1977715968)
